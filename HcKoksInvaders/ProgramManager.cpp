...
ProgramManager::ProgramManager()
{
	...
	button_vert.loadFromFile("res/shaders/button_vert.vert",Shader::ShaderType::Vertex);
	button_frag.loadFromFile("res/shaders/button_frag.frag",Shader::ShaderType::Fragment);
